# Overview
`typst-scienceposters` allows to create simple but elegant posters.
...
To find out what you can do today with `typst-scienceposters`, have a look at the [showcased examples](showcase).
