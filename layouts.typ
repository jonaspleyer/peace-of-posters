...
#let poster-layout(layout: layout-a0, ..args, body) = {
  ...
  set page(paper: args
    .named()
    .at("paper", default: layout.at("paper", default: layout-a0.at("paper"))))

  // Set default text size
  set text(size: args
    .named()
    .at("body-size", default: layout.at("body-size", default: layout-a0.at("spacing"))))

  // Set spacing between blocks.
  // We also want to adjust the gutter between columns
  set block(spacing: args
    .named()
    .at("spacing", default: layout.at("spacing", default: layout-a0.at("spacing"))))
  set columns(gutter: args
    .named()
    .at("spacing", default: layout.at("spacing", default: layout-a0.at("spacing"))))
